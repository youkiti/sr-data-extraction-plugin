...
- **作成日**: 2026-07-03（タスク A〜E）/ **更新**: 2026-07-12（v0.1.0 公開後のマイルストーン M1〜M4 を追加）・2026-07-18（#62 実機検証の §7.3 決着 = フォルダ付与不成立 → ファイル単位付与への設計変更〔#138/#139 = PR #140〕と進捗を反映）・2026-07-19（#62 実機通し完了 = 検証 → 裁定 → consensus エクスポートまで全項目 OK。#62 クローズ・#63/#141 の残確認を更新）
- **対象読者**: 本リポジトリで作業する実装者
