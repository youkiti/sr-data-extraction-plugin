...
| **P1** | 二重独立抽出 + 不一致解決画面（tiab-review「担当セット」の思想を移植 ※Q4）、tiab-review プロジェクト引き継ぎ、OpenRouter カスタムモデルの管理 UI（プロバイダ実装 + モデルセレクタは 2026-07-04 に MVP へ前倒し済み）、RoB テンプレートスキーマ、UI 英語化 |
