...
- **host_permissions**: Sheets / Google APIs / Gemini / OpenRouter の 4 つ。すべて BYOK の API 通信 or Google API で正当。OpenAI 互換 API は `optional_host_permissions` とし、利用者が設定した origin だけを実行時に要求する。✅
