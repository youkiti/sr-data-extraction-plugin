...
// 拡張本体の i18n（src/lib/i18n。ja / en の 2 言語）に合わせ、ページも「併記」ではなく
// 「切替」で 1 言語だけを表示する。
//
// 仕組み:
...
//     （拡張本体は HELP_URL 等へ ?lang= を付けて開く。src/lib/publicPages.ts）
...
(function () {
  ...
  var STORAGE_KEY = 'sr-data-extraction-plugin.lang';
