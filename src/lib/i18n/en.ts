...
export const en: Record<MessageKey, string> = {
  ...
  'documents.reasonIneligible': 'Determined ineligible',
  'documents.reasonDuplicate': 'Duplicate',
  'documents.reasonMisImported': 'Imported by mistake',
  'documents.reasonOnHold': 'On hold',
  'documents.reasonOther': 'Other (add free text)',
  ...
  // S3 exclusion feature (issue #181)
  'documents.excludeStudyButton': 'Exclude this study',
  'documents.excludeStudyAria': 'Exclude {label} from extraction candidates',
  'documents.restoreStudyButton': 'Restore this study',
  'documents.restoreStudyAria': 'Restore {label} from exclusion',
  'documents.allDocsExcludedNote':
    "All documents of this study are excluded (it's dropped from extraction candidates).",
  'documents.excludeDocumentButton': 'Exclude',
  'documents.excludeDocumentAria': 'Exclude {filename} from extraction candidates',
  'documents.restoreDocumentButton': 'Restore',
  'documents.restoreDocumentAria': 'Restore {filename} from exclusion',
  ...
  'documents.exclusionDialogBody': 'This excludes "{label}" from extraction candidates.',
  'documents.exclusionReasonLabel': 'Exclusion reason',
  'documents.exclusionReasonPlaceholder': '(Select a reason)',
  'documents.exclusionNoteLabel': 'Note (optional)',
  'documents.exclusionReasonRequiredHint': 'Excluding a whole study requires selecting a reason.',
  'documents.exclusionConfirm': 'Exclude',
  ...
  'schema.rowMoveUp': '↑',
  'schema.rowMoveDown': '↓',
  'schema.rowMoveUpAria': 'Move row {row} up',
  'schema.rowMoveDownAria': 'Move row {row} down',
  ...
  'schema.sortBySection': 'Group by section',
  ...
  'extract.selectAllUnextracted': 'Select all unextracted',
  'extract.deselectAllStudies': 'Clear all',
  'extract.studiesExtractedExcluded': '{n} already-extracted studies are excluded from select-all',
  ...
  'documents.toastStudyExcluded': 'Excluded {label} from extraction candidates',
  'documents.toastDocumentExcluded': 'Excluded {filename} from extraction candidates',
  'documents.toastRestored': 'Restored {label} from exclusion',
  'documents.toastExcludeReasonRequired': 'Excluding a whole study requires selecting a reason',
  'documents.toastExcludeFailed': 'Exclusion failed: {reason}',
  'documents.toastRestoreFailed': 'Restore failed: {reason}',
